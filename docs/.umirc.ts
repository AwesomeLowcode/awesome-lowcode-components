...
const productPath = `/@ablula/awesome-lowcode-components@${version}/build/docs/`;
...
export default defineConfig({
  ...
  chainWebpack(memo) {
    ...
    memo.resolve.alias.set('@ablula/awesome-lowcode-components', join(__dirname, '../src'));
  },
  ...
  alias: {
    ...
    '@ablula/awesome-lowcode-components': join(__dirname, '../src'),
  },
  apiParser: {
    propFilter: (prop) => {
